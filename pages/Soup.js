      ...
      <ScrollView style={{ width: '100%' }}>
        <View style={styles.transparentCard}>
          ...
          <View style={styles.whiteCard}>
            <Image
              source={require('../assets/French Onion Soup.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>French Onion Soup</Text>
              <Text style={styles.foodDescription}>Caramelized onions in a rich broth, topped with melted Gruyère cheese crouton.</Text>
              
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Kathryn Bernardo</Text>
                <TouchableOpacity onPress={() => toggleFavorite('French Onion Soup')}>
                  <Icon
                    name={favorites.includes('French Onion Soup') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('French Onion Soup') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('FrenchOnionSoup')} style={styles.viewButton}>
          ...
          <View style={styles.whiteCard}>
            <Image
              source={require('../assets/Butternut Squash Soup.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Butternut Squash Soup</Text>
              <Text style={styles.foodDescription}>Creamy, spiced squash puree garnished with roasted seeds and a swirl of cream.</Text>
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Niki Samantha</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Butternut Squash Soup')}>
                  <Icon
                    name={favorites.includes('Butternut Squash Soup') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Butternut Squash Soup') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('ButternutSquashSoup')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.whiteCard}>
            ...
            <Image
             source={require('../assets/Clam Chowder.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Clam Chowder</Text>
              <Text style={styles.foodDescription}> Creamy New England classic brimming with clams, potatoes, and smoky bacon. </Text>
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Liza Soberano</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Clam Chowder')}>
                  <Icon
                    name={favorites.includes('Clam Chowder') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Clam Chowder') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('ClamChowder')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
