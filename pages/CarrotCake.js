...
const CarrotCake = ({ navigation }) => {
    ...
    const getContent = () => {
        switch (activeTab) {
            case 'OVERVIEW':
                return 'Carrots add sweetness and moisture to a batter. Carrot cakes have been around for centuries, but the modern carrot cake can be traced back to World War II when carrots were suggested as a way to add sweetness to cakes when sugar was being rationed, according to the World Carrot Museum of Skipton, England.';
            case 'INGREDIENTS':
                return '• 3/4 cup packed dark brown sugar\n' +
                       '• ⅔ cup canola oil\n' +
                       '• 1 egg\n' +
                       '• 1 cup all-purpose flour\n' +
                       '• ¾ teaspoon ground cinnamonn\n' +
                       '• 1 inch piece ginger, minced\n' +
                       '• ½ teaspoon salt\n' +
                       '• 1 cup grated carrots\n' +
                       '• ⅓ cup chopped walnuts';
            case 'PROCEDURE':
                return '1.) Position the oven racks in the center and lower third of the oven. Fill a roasting pan halfway with water and place onto the lower rack. Preheat the oven to 350 degrees F (175 degrees C). Grease a 9-inch springform pan with cooking spray.\n' +
                       '2.) Make the cheesecake: Beat cream cheese in a large bowl with an electric mixer on high speed until fluffy. Add sugar and beat on medium-low speed for 2 minutes. Mix in sour cream and vanilla until smooth. Stir in flour and set aside.\n' +
                       ...
                       '5.) Place cake into the preheated oven on the center rack (above the roasting pan with water). Remove from the oven, place onto a wire rack, and let cool for 10 minutes.\n' +
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
              ...
              <Text style={styles.text2}>Carrot Cake</Text>
            ...
            <View style={styles.card}>
                <Image source={require('../assets/carrotcake.jpg')} style={styles.cardImage} />
                <View style={styles.textContainer}>
                    <Text style={styles.cardTitle}>Carrot Cake</Text>
                </View>
