...
const ItalianBeef = ({ navigation }) => {
    ...
    const getContent = () => {
        switch (activeTab) {
            case 'OVERVIEW':
                return 'An Italian beef is a sandwich originating from Chicago made from thin slices of roast beef simmered and served au jus on French bread. Common toppings are a choice between spicy giardiniera or mild bell peppers.';
            case 'INGREDIENTS':
                return '• 3 to 4 pound chuck roast or round roast trimmed of large chunks of excess fat\n' +
                '• Kosher salt\n' +
            ...
            case 'PROCEDURE':
                return '1.) Let the meat rest at room temperature. Salt the beef.\n' +
                       '2.) Sear the beef, then transfer it to the slow cooker.\n' +
                       '3.) Deglaze the pan with beef broth, then add the liquid to the slow cooker.\n' +
                       '4.) Stir the seasoning ingredients together, then sprinkle them over the beef.\n' +
                       '5.) Add the peppers and giardiniera.\n' +
                       '6.) Cook on LOW for 8 to 10 hours. Shred the beef. Cook for another 30 minutes.\n' +
                       '5.) Toast the buns at 350 degrees F for 5 to 7 minutes. Top the buns with the beef, cheese, and additional pepperoncini and giardiniera. DIG IN!.\n' ;
            default:
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
              ...
              <Text style={styles.text2}>Italian Beef</Text>
            ...
            <View style={styles.card}>
                <Image source={require('../assets/Italian Beef.jpg')} style={styles.cardImage} />
                <View style={styles.textContainer}>
                    <Text style={styles.cardTitle}>Italian Beef</Text>
                </View>
