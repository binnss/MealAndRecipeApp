...
import StrawberryCake from './StrawberryCake';
      ...
      <ScrollView style={{ width: '100%' }}>
        <View style={styles.transparentCard}>
          ...
          <View style={styles.whiteCard}>
            <Image
              source={require('../assets/carrotcake.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Carrot Cake</Text>
              <Text style={styles.foodDescription}>You get moist carrot cake and creamy cheesecake in every bite.</Text>
              
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Kathryn Bernardo</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Carrot Cake')}>
                  <Icon
                    name={favorites.includes('Carrot Cake') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Carrot Cake') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('CarrotCake')} style={styles.viewButton}>
          ...
          <View style={styles.whiteCard}>
            ...
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Rhubarb Cake</Text>
              <Text style={styles.foodDescription}>Juicy tomatoes, crisp cucumber, sharp feta, and olives in a herby vinaigrette.</Text>
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Niki Samantha</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Rhubarb Cake')}>
                  <Icon
                    name={favorites.includes('Rhubarb Cake') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Rhubarb Cake') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('RhubarbCake')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.whiteCard}>
            ...
            <Image
             source={require('../assets/StrawberryCake.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Strawberry Cake</Text>
              ...
              <View style={styles.authorContainer}>
                ...
                <TouchableOpacity onPress={() => toggleFavorite('Strawberry Cake')}>
                  <Icon
                    name={favorites.includes('Strawberry Cake') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Strawberry Cake') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('StrawberryCake')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
