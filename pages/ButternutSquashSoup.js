...
const ButternutSquashSoup = ({ navigation }) => {
    ...
    const getContent = () => {
        switch (activeTab) {
            case 'OVERVIEW':
                return 'Butternut squash and cool weather go together like they were made for each other—which, really, they were. I was so happy to find butternut in stock again, and came home to make my favorite soup.';
            case 'INGREDIENTS':
                return '• 2 tablespoons extra-virgin olive oil\n' +
                '• 21 large yellow onion, chopped\n' +
                '• 2½ teaspoon sea salt\n' +
                '• 21 (3-pound) butternut squash, peeled, seeded, and cubed\n' +
                '• 23 garlic cloves, chopped\n' +
                '• 21 tablespoon chopped fresh sage\n' +
                '• 2½ tablespoon minced fresh rosemary\n' +
                '• 21 teaspoon grated fresh ginger\n' +
                '• 23 to 4 cups vegetable broth\n' +
                '• 2 Freshly ground black pepper\n' ;
            case 'PROCEDURE':
                return '1.) Heat the oil in a large pot over medium heat. Add the onion, salt, and several grinds of fresh pepper and sauté until soft, 5 to 8 minutes. Add the squash and cook until it begins to soften, stirring occasionally, for 8 to 10 minutes.\n' +
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
              ...
              <Text style={styles.text2}>Butternut Squash Soup</Text>
            ...
            <View style={styles.card}>
                <Image source={require('../assets/Butternut Squash Soup.jpg')} style={styles.cardImage} />
                <View style={styles.textContainer}>
                    <Text style={styles.cardTitle}>Butternut Squash Soup</Text>
                </View>
