      ...
      <ScrollView style={{ width: '100%' }}>
        <View style={styles.transparentCard}>
          ...
          <View style={styles.whiteCard}>
            <Image
              source={require('../assets/Spaghetti Carbonara.jpg')}
              style={styles.foodImage}
              resizeMode="cover"
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Carbonara</Text>
              <Text style={styles.foodDescription}>Creamy eggs and crispy pancetta combine in this classic Roman indulgence.</Text>
              
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Kathryn Bernardo</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Carbonara')}>
                  <Icon
                    name={favorites.includes('Carbonara') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Carbonara') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('Carbonara')} style={styles.viewButton}>
          ...
          <View style={styles.whiteCard}>
            ...
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Pesto Genovese</Text>
              <Text style={styles.foodDescription}>Fresh basil pesto, pine nuts, and Parmesan clinging to al dente pasta.</Text>
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Niki Samantha</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Pesto Genovese')}>
                  <Icon
                    name={favorites.includes('Pesto Genovese') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Pesto Genovese') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('PestoGenovese')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.whiteCard}>
            ...
            />
            <View style={styles.textContainer}>
              <Text style={styles.foodTitle}>Seafood Linguine</Text>
              <Text style={styles.foodDescription}> Delicate linguine tossed with shrimp, mussels, and clams in a garlic wine sauce. </Text>
              <View style={styles.authorContainer}>
                <Text style={styles.authorName}>By Liza Soberano</Text>
                <TouchableOpacity onPress={() => toggleFavorite('Seafood Linguine')}>
                  <Icon
                    name={favorites.includes('Seafood Linguine') ? 'heart' : 'heart-o'}
                    size={16}
                    color={favorites.includes('Seafood Linguine') ? 'red' : 'black'}
                    style={styles.favoriteIcon}
                  />
                </TouchableOpacity>
              </View>
              <TouchableOpacity onPress={() => navigation.navigate('SeafoodLinguine')} style={styles.viewButton}>
                <Text style={styles.viewButtonText}>View</Text>
              </TouchableOpacity>
            </View>
          </View>
